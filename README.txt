...
cd "C:\Users\NEEL\OneDrive\Desktop\Python\My_Projects\driver_sleep_web"
Remove-Item -Recurse -Force mp-env
py -3.11 -m venv mp-env
.\mp-env\Scripts\Activate.ps1
pip install --upgrade pip
pip install flask opencv-python mediapipe==0.10.14 numpy
python app.py